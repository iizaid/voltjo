...
const testimonials1: Testimonial[] = [
  ...
  {
    text: "وجود مساعد يشرح السيارات المتوفرة في السوق الأردني أفضل من سؤال ذكاء عام لا يعرف تفاصيل الدعم والضمان المحلي.",
    name: "محمد",
...
const testimonials3: Testimonial[] = [
  {
    text: "لو كانت البيانات محدثة باستمرار، ستكون أداة ممتازة قبل زيارة المعارض أو التواصل مع البائعين.",
    name: "هبة",
