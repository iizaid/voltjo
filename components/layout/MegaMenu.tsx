...
export function MegaMenu({ columns }: { columns: MegaMenuColumnData[] }) {
  return (
    <div
      className="mega-menu-panel overflow-hidden rounded-[14px] border border-[var(--voltjo-border)] bg-white/96 shadow-[0_16px_38px_rgba(13,13,13,0.075)] backdrop-blur-xl"
      dir="rtl"
    >
      <div
        className={`grid ${
